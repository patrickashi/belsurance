...
const Secfive = () => {
    return (
        <div className="px-4 md:px-20 py-20 bg-[#1B2F27] hover:bg-violet-300 hover:text-black duration-200 text-gray-200   border-gray-300">
            <div className="flex gap-16 flex-col md:flex-row">
                <div className="text-7xl font-bold">03</div>
                <div className="text-4xl flex items-center w-60">Mental Health Coverage</div>

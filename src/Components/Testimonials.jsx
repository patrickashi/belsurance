        ...
        <div className="px-4 md:px-20 py-20  duration-200">
            ...
            {/* <div className="flex flex-col">
                <div className="flex justify-center object-cover">
                    <div className="border border-gray-400 py-8 px-2 md:6 w-100"><img src={leahyurfset} alt="img" className=" w-80 h-60 rounded-tl-full rounded-r-full object-cover"/></div>
                    <div className="border border-gray-400 py-8 px-2 md:6 w-100"><img src={roygold} alt="img" className=" w-80 h-60 rounded-tl-full rounded-r-full object-cover" /></div>
                    <div className="border border-gray-400 py-8 px-2 md:6 w-100"><img src={nelayliuay} alt="img" className=" w-80 h-60 rounded-tl-full rounded-r-full object-cover "/></div>
                </div>
